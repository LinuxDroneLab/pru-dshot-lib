...
#ifndef INCLUDE_PRU_DSHOT_DRIVER_H_
#define INCLUDE_PRU_DSHOT_DRIVER_H_
...
uint8_t pru_dshot_lib_SetData(uint8_t pwmssDevice, uint16_t period, uint16_t duA, uint16_t duB);
...
#endif /* INCLUDE_PRU_DSHOT_DRIVER_H_ */
